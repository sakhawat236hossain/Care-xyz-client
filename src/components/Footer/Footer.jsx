        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1 space-y-6">
            ...
            <p className="text-gray-500 dark:text-gray-400 leading-relaxed text-sm">
              We are committed to providing safe and reliable services to your
              family members. Specialized caregiving services for children, the
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-600 dark:text-gray-400">
              <li className="flex items-center space-x-3">
                <span className="bg-blue-50 dark:bg-blue-900/30 p-1.5 rounded-md text-blue-600 dark:text-blue-400">
                  📍
                </span>
