      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <div className="flex items-center bg-zinc-100/50 dark:bg-zinc-900/50 p-1.5 rounded-full border border-zinc-200/50 dark:border-zinc-800/50">
              ...
              {status === "authenticated" && (
                <Link
                  href="/dashboard"
                  className="relative group p-2 ml-1 transition-transform active:scale-90"
                >
                  <ShoppingBag
                    size={22}
            ...
            <div className="flex items-center gap-4">
              {status === "authenticated" ? (
                    ...
                    <div className="absolute right-0 top-full mt-4 w-64 bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-zinc-100 dark:border-zinc-800 p-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                      <div className="flex items-center gap-3 p-3 mb-2 bg-zinc-50 dark:bg-zinc-800/50 rounded-xl">
                        ...
                        <div className="flex flex-col overflow-hidden">
                          ...
                          <p className="text-[10px] font-medium text-indigo-600 dark:text-indigo-400 uppercase tracking-tight">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <Link
                    href="/register"
                    className="bg-indigo-600 text-white px-6 py-2.5 rounded-full text-sm font-bold transition-all shadow-lg shadow-indigo-600/20 active:scale-95"
                  >
                    Get Started
                  </Link>
                </div>
          ...
          <button
            ...
            className="md:hidden p-2.5 rounded-xl bg-zinc-100 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 border border-zinc-200 dark:border-zinc-800"
          >
            ...
            <div className="flex flex-col space-y-1">
              ...
              {status === "authenticated" && (
                <Link
                  href="/dashboard"
                  onClick={() => setIsOpen(false)}
                  className="px-5 py-3.5 rounded-xl font-bold text-indigo-600 flex justify-between items-center bg-indigo-50"
                >
              ...
              {status === "authenticated" ? (
                <div className="grid grid-cols-2 gap-3">
                  <Link
                    href="/dashboard"
                    onClick={() => setIsOpen(false)}
                    className="flex items-center justify-center gap-2 py-3.5 bg-zinc-900 text-white rounded-xl font-bold"
                  >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    onClick={() => signIn()}
                    className="py-3.5 bg-zinc-100 rounded-xl font-bold text-zinc-700"
                  >
                    Login
                  </button>
                  <Link
                    href="/register"
                    className="text-center py-3.5 bg-indigo-600 text-white rounded-xl font-bold"
                  >
                    Join Now
                  </Link>
                </div>
